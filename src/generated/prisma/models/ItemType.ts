...
export type ItemTypeOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<'id' | 'createdAt' | 'categoryId' | 'name' | 'image' | 'description' | 'shortDescription' | 'basePrice' | 'salePercent' | 'displayOrder' | 'soldOut', ExtArgs['result']['itemType']>
