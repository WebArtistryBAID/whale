...
export type OrderOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<'id' | 'totalPrice' | 'totalPriceRaw' | 'status' | 'createdAt' | 'updatedAt' | 'type' | 'deliveryRoom' | 'userId' | 'paymentStatus' | 'paymentMethod' | 'stripeSession' | 'wxPayId', ExtArgs['result']['order']>
