...
export type AdWhereInput = {
    ...
    url?: Prisma.StringFilter<'Ad'> | string
}
...
export type AdScalarWhereWithAggregatesInput = {
    ...
    url?: Prisma.StringWithAggregatesFilter<'Ad'> | string
}
...
export type AdOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<'id' | 'name' | 'image' | 'url', ExtArgs['result']['ad']>
...
export interface AdFieldRefs {
    ...
    readonly url: Prisma.FieldRef<'Ad', 'String'>
}
