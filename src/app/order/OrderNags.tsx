...
export default function OrderNags() {
    ...
    return <>
        <Modal show={storeClosedModal && !loginModal} onClose={() => setStoreClosedModal(false)}>
            ...
            <ModalFooter>
                <Button pill color="warning" onClick={() => setStoreClosedModal(false)}>{t('confirm')}</Button>
            </ModalFooter>
        </Modal>

        <Modal show={atCapacityModal && !storeClosed && !loginModal} onClose={() => setAtCapacityModal(false)}>
            <ModalHeader>{t('maximumCupsModal.title')}</ModalHeader>
            <ModalBody>
                <p>{t('maximumCupsModal.message')}</p>
            </ModalBody>
            <ModalFooter>
                <Button pill color="warning" onClick={() => setAtCapacityModal(false)}>{t('confirm')}</Button>
            </ModalFooter>
        </Modal>
