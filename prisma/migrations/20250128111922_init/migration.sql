...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('orderCreated', 'pickupReminder', 'orderRefunded', 'custom', 'balanceToppedUp', 'pointsEarned');
...
-- CreateEnum
CREATE TYPE "UserAuditLogType" AS ENUM ('login', 'blocked', 'unblocked', 'permissionsUpdated', 'balanceUpdated', 'pointsUpdated', 'orderCreated', 'orderSetStatus', 'orderPaymentSuccess', 'orderPaymentFailed', 'orderRefunded');
...
(
    ...
    "inboxNotifications" "NotificationType"[] DEFAULT ARRAY[]::"NotificationType"[],
    "smsNotifications"   "NotificationType"[] DEFAULT ARRAY[]::"NotificationType"[],
